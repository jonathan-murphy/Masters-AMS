package com.example.jonny.csvtest;
...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    static int beepDelay = 2000; // enter time in milliseconds
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        if (i < samples && save == true) {
            ...
            mylist.add(new String[] {Float.toString(gForce),Float.toString(prevGForce),Float.toString(difference),Float.toString(startTime),Float.toString(minTime),Float.toString(maxTime)});
            i = i+1;
        }
